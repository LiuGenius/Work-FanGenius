...
//流程1：客户端登录websock协议后向服务端发送以下数据，服务端收到请求后将数据存储到服务器
{
	"function":"userJoin"
	"userId":"XXX",//用户ID
...
//流程2：每当有新用户加入或者有用户退出，服务端向用户端发送以下数据
{
...
//流程4：用户端游戏时，每当进度变更向服务端发送以下数据，收到进度值为100时，代表该用户游戏结束，记录游戏时间和分数
...
//流程5：当服务端收到客户端游戏进度变更的信息时，向用户端发送以下协议
...
//流程6：当服务端收到所有用户端游戏进度为完成时，向所有客户端发送以下协议
